...
function extendTheme(themeOptions) {
  ...
  const theme = (0, _extends2.default)({
    ...
    variants: (0, _utils.deepmerge)({
      ...
      // variant overrides
      plainOverrides: (0, _variantUtils.createTextOverrides)(variantInput),
      outlinedOverrides: (0, _variantUtils.createTextOverrides)(variantInput),
      softOverrides: (0, _variantUtils.createTextOverrides)(variantInput),
      solidOverrides: (0, _variantUtils.createContainedOverrides)(variantInput)
    }, variantsInput),
    cssVarPrefix,
    getCssVar,
