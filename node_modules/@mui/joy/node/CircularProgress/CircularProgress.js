...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', determinate && 'indeterminate', color && `color${(0, _utils2.unstable_capitalize)(color)}`, variant && `variant${(0, _utils2.unstable_capitalize)(variant)}`, size && `size${(0, _utils2.unstable_capitalize)(size)}`],
    svg: ['svg'],
    track: ['track'],
    progress: ['progress']
  };
